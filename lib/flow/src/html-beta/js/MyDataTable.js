function MyDataTable(
    ...
    function setData(dataIn){
        ...
        data.forEach(function(dataEntry, index){
            ...
            configuration.forEach(function(columnConf, index){
                ...
                td.html(  (columnConf.type == "NUMBER" ? 
                            formatNumber(dataEntry[columnConf.key]) 
                            : dataEntry[columnConf.key])
                            + (columnConf.unit != null ? (" " + columnConf.unit) : "")
                        );
            });
        });
    ...
    function init(){
        ...
        sorting.ascending = !options.reverse;
